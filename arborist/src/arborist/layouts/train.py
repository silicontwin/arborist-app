...
class Ui_TrainTab(object):
    def setupUi(self, TrainTab):
        ...
        self.modelComboBox.setMinimumSize(QSize(100, 0))
        ...
        self.outcomeComboBox.setMinimumSize(QSize(200, 0))
        ...
        sizePolicy1.setHeightForWidth(self.codeGenPushButton.sizePolicy().hasHeightForWidth())
        self.codeGenPushButton.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.parametersPushButton.sizePolicy().hasHeightForWidth())
        self.parametersPushButton.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.trainResetButton.sizePolicy().hasHeightForWidth())
        self.trainResetButton.setSizePolicy(sizePolicy1)
