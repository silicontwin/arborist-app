...
const Upload = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-start items-start">
      {/* <div
        id="statusBar"
        className="h-[30px] text-sm w-full flex flex-row justify-start items-center px-4 space-x-4"
      >
        ...
        <div className="flex space-x-1">
          Workspace path: <span className="">`{userDataPath}`</span>
        </div>
      </div> */}
            ...
            <div className="h-[calc(100vh_-_80px)] flex flex-col justify-center items-center w-full space-y-4">
              ...
              <div className="flex flex-row justify-start items-center space-x-2">
                ...
                <ul className="flex flex-row justify-start items-center space-x-2">
                  <li className="border-[2px] rounded-full px-[10px] py-[4px]">
                    .csv
                  </li>
                  {/* <li className="border-[2px] rounded-full px-[10px] py-[4px]">
                    .spss
